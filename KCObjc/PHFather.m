...
//        Method syyMethod  = class_getInstanceMethod(objc_getMetaClass("PHFather"), NSSelectorFromString(@"lgClassMethod"));
//        const char *type  =  method_getTypeEncoding(syyMethod);
